...
<?php $__env->startSection('content'); ?>
    ...
    <header class="site-hero text-center text-white py-5" style="background: linear-gradient(135deg, #06131a 0%, #1a3a52 100%);">
        <div class="container">
            ...
            <a href="#featured-products" class="btn btn-warning btn-lg">Shop Now</a>
        </div>
    </header>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm product-card" style="transition: all 0.3s ease; border-radius: 12px; overflow: hidden;">
                            <div class="card-img-wrapper position-relative overflow-hidden view-product" style="height: 280px; background: linear-gradient(135deg, #dee2e6 0%, #ced4da 100%); cursor: pointer;" data-product='<?php echo json_encode($product, 15, 512) ?>'>
                                <img src="<?php echo e($product->image_url); ?>" class="card-img-top w-100 h-100" alt="<?php echo e($product->product_name); ?>" style="object-fit: contain; padding: 20px; transition: transform 0.3s ease;">
                            ...
                            <div class="card-body d-flex flex-column p-4">
                                ...
                                <p class="card-text mb-3" style="font-size: 1.25rem; font-weight: 700; color: #000;">₱<?php echo e(number_format($product->price, 0)); ?></p>
                                <div class="card-actions mt-auto">
                                    <a href="#" class="btn btn-warning w-100 mb-2 buy-now" data-product='<?php echo json_encode($product, 15, 512) ?>' title="Buy now" style="border-radius: 8px; font-weight: 600; padding: 12px; background: linear-gradient(135deg, #ffc107 0%, #ff9800 100%); border: none; color: #000; box-shadow: 0 4px 6px rgba(255, 193, 7, 0.3); transition: all 0.3s ease;">
                                        <i class="fas fa-bolt me-2"></i>Buy Now
                                    </a>
                                    <a href="#" class="btn btn-outline-secondary w-100 add-to-cart" data-product-id="<?php echo e($product->product_id); ?>" title="Add to your cart" style="border-radius: 8px; font-weight: 600; padding: 12px; border: 2px solid #6c757d; color: #6c757d; transition: all 0.3s ease;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Commerce-Laravel-main\resources\views/index.blade.php ENDPATH**/ ?>