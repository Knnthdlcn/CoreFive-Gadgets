...
<body style="margin:0; padding:0; background:#f6f7fb; font-family: Arial, Helvetica, sans-serif;">
    <div style="max-width: 560px; margin: 0 auto; padding: 24px 16px;">
        <div style="background: #06131a; color:#fff; border-radius: 14px 14px 0 0; padding: 18px 20px;">
            ...
            <div style="opacity: 0.8; font-size: 13px; margin-top: 4px;">Email verification code</div>
        </div>

        <div style="background:#fff; border-radius: 0 0 14px 14px; padding: 22px 20px; border: 1px solid #e9ecf3; border-top: none;">
            <p style="margin: 0 0 12px 0; color:#1f2d3a; font-size: 14px;">Use this code to verify your email address:</p>
            ...
            <p style="margin: 14px 0 0 0; color:#51606d; font-size: 13px; line-height: 1.5;">
                This code expires in <strong>{{ $expiresMinutes }} minutes</strong>. If you didn’t create an account, you can ignore this email.
            </p>
